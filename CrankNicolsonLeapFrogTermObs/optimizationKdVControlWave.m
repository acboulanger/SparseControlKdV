function [u,y,p,args] = optimizationKdVControlWave()
...
%             CheckGradient(u, ugradient - u, @solveState, @solveAdjoint, @compute_j, @compute_derivatives_j, args);
        ...
        saveas(figure(2),strcat(...
            '/home/boulange/linux/Dropbox/KDV/SparseControlKdV/CrankNicolsonLeapFrogTermObs/Fig/','norm2q',...
        ...
        saveas(figure(3),strcat(...
            ...
            'controlproblem2_Gamma_',num2str(floor(1.0/gamma))),'fig');
...
function args = CreateParameters()
    ...
    args.tmax = 20.00;% maximum time for simulation
